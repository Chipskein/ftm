...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output", help="Path to output image(default: image_translated.jpg in tmp dir)")

    parser.add_argument("--tmp", default="./tmp", help="Path to temporary directory (default: ./tmp)")
    ...
    parser.add_argument(
        ...
        help="Path to JSON file with bubble data (skips detection steps)",
    )
    ...
    parser.add_argument(
        '--use-cpu-step', nargs='+', choices=['detection', 'extraction'],
...
def main():
    ...
    print(f"  use_cpu_all: {args.use_cpu_all}")
    print(f"  use_cpu_step: {args.use_cpu_step}")
    print(f"└── ")
